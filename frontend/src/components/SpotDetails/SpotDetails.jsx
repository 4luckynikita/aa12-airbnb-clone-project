...
const SpotDetails = () => {
    ...
    const isReviewed = reviewsState.some(review => review.userId === currentUser);
                ...
                <div className='spot-container' key={spotId}>
                    <div className='spot-details'>
                        ...
                        <div className='spot-reviews-container'>
                            ...
                            {currentUser && currentUser !== spotOwner && !isReviewed &&<OpenModalButton
                            ...
                            {reviewsArr.map((review) => (
                                <div className='review-container' key={review?.id}>
                                    ...
                                    {review.userId === currentUser && <DeleteReviewModal reviewId={review.id} spotId={spotId} />}
                                </div>
                            ))}
                        </div>
                    </div>
